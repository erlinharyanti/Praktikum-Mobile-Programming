...
class _FormMahasiswaPageState extends State<FormMahasiswaPage> {
  ...
  String get tglLahirLabel => tglLahir == null
      ? 'Pilih Tanggal Lahir' //? turnary if else
  ...
  Future<void> _pickDate() async {
    //async berhubungan sm await
    final res = await showDatePicker(
      context: context,
      firstDate: DateTime(2000), //tgl pertama
      initialDate: DateTime.now(), //tgl akhir
      lastDate: DateTime(
        DateTime.now().year + 1,
      ), //waktu default tgl sekarang + 1 taun kedepan
    );
    if (res != null) setState(() => tglLahir = res); //res ini berisi apa ngga, kalo berisi dia set state
  }
  ...
  void _simpan(){
    if(!_formKey.currentState!.validate()|| tglLahir == null || jamBimbingan == null){
      ...
      child: Form(
        ...
        child: ListView(
          children: [
            ...
            TextFormField(
              controller: cNpm,
              decoration: const InputDecoration(labelText: 'NPM', prefixIcon: Icon(Icons.badge)),
            ...
            TextFormField(
              ...
              validator: (value) {
                ...
                if (!RegExp(r'^\d+$').hasMatch(value)) return 'Nomor HP harus berupa angka';
            ...
            DropdownButtonFormField<String>(
              ...
              validator: (value) =>
              value == null || value.isEmpty ? 'Jenis kelamin harus dipilih' : null,
            ),
